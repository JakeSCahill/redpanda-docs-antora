...
You can use glossterm:rpk[A command-line tool for managing Redpanda] to start a local cluster.

This is a paragraph about glossterm:SAN list[] and TLS certificates.
