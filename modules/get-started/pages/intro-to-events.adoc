= Introduction to Redpanda {page-version}
:pp: {plus}{plus}
:description: Explanation of Redpanda event streaming.
:page-context-links: [{"name": "Test one", "to": "intro-to-events.adoc" },{"name": "Test two", "to": "architecture.adoc" } ]
:link-with-anchor: tabs?tab=_tabs_3_lorem#_tabs_#3_lorem

You can link to other tabs too by using link:tabs?tab=_tabs_1_macos[Section A]

You can link to other tabs too by using link:tabs?tab=_tabs_2_windows[Section B]

Linking to a tab with anchor tag link:{link-with-anchor}[Section B]
...
include::partial$example.adoc[leveloffset=+1]
